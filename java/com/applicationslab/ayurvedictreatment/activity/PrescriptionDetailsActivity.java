...
public class PrescriptionDetailsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String disease = "General Consultation"; // Default to prevent empty data
    ...
    private void initData() {
        // Safety check for the intent data
    ...
    // --- CHANGED FROM EMAIL TO DATABASE API ---
    private void requestPrescriptionApi() {
        ...
        StringRequest mRequest = new StringRequest(Request.Method.POST, Urls.URL_REQUEST_PRESCRIPTION,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if(success == 1) {
                                new CustomToast(PrescriptionDetailsActivity.this, "Request sent successfully", "", false);
                                finish(); // Close the activity
                            } else {
                                new CustomToast(PrescriptionDetailsActivity.this, message, "", false);
                            }
                        } catch (Exception e) {
                            mDialog.dismiss();
                            new CustomToast(PrescriptionDetailsActivity.this, "Error: " + e.getMessage(), "", false);
                        }
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                mDialog.dismiss();
                new CustomToast(PrescriptionDetailsActivity.this, "Network Error", "", false);
            }
        }) {
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
                Map<String, String> params = new HashMap<>();
                PreferenceUtil preferenceUtil = new PreferenceUtil(PrescriptionDetailsActivity.this);
    ...
    public void onClick(View v) {
        if(v.getId() == R.id.btnSubmit) {
            if(isDataValid()) {
                // Call the API method instead of sendEmail()
